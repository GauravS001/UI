...
for(let i = 0; i<5; i++){
    a.push(
        <View key={i} style={{backgroundColor: "transparent", paddingRight: 5, paddingTop: 5, paddingBottom: 5, paddingLeft: 5, marginLeft: 5, marginTop: 0}}>
            ...
            <Text style={{fontSize: 16.5, fontWeight: 500, marginTop: 2, width: 150}} numberOfLines={2}>{Title[i]}</Text>
            ...
            <Text style={{fontSize: 14, color: "rgb(152, 149, 148)", position: "absolute", marginTop: 179, marginLeft: 45.5, fontWeight: 400}}>{Rtcount[i]}</Text>
            ...
            <Text style={{fontSize: 15, fontWeight: 500, position: "absolute", marginTop: 253, marginLeft: 40}}>{'\u20B9'}{price[i]}</Text>
...
export default function PopularActivities(){
    ...
    return(
        ...
        <View style={{width: "100%", paddingTop: 5, paddingBottom: 10, backgroundColor: "white"}}>
           <Text style={{fontSize: 22, marginLeft: 20, fontWeight: 600}}>Popular activities</Text>
           <Text style={{position: "absolute",  textDecorationLine: 'underline', marginLeft: 270, marginTop: 10, fontSize: 17}}>See more</Text>
